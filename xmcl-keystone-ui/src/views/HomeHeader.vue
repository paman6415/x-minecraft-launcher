<template>
  ...
  >
    ...
    >
      ...
      <AvatarItem
        v-ripple
        :color="!resolvedVersion?.id ? 'warning' : 'primary'"
        icon="fact_check"
...
const currentVersion = computed(() => !resolvedVersion.value?.id ? t('version.notInstalled') : resolvedVersion.value.id)
